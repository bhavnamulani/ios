...
var senderFlag = 0
var chatMessagesList = [MessagesDo]()

//********************************************************************************

class LGChatController: UIViewController, UITableViewDelegate, UITableViewDataSource, LGChatInputDelegate, LGChatControllerDelegate,XMPPMessageCallback{
...
//        let messageText = chatMessagesList[indexPath.row]
...
//    func onMessageReceive(_ senderUserName: String, message: String)  {
//        var messagesDo: MessagesDo?
//        messagesDo = MessagesDo()
//        messagesDo?.msgText = message
//        messagesDo?.sentBy = .Opponent
//        chatMessagesList.append(messagesDo!)
//
//    }
//    
//    func onMessageSend(userType:String,messageText:String)  {
//        var messagesDo: MessagesDo?
//        messagesDo = MessagesDo()
...
//    func sendMessage (messageText:String, sentBy:LGChatMessage.SentBy) {
//        xmppManager.sendMessage(self.title!, message: messageText)
//    }
